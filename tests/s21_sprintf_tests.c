...
START_TEST(simple_int) {
  ...
  int val = 69;
  ck_assert_int_eq(s21_sprintf(str1, format2, val), sprintf(str2, format, val));
...
START_TEST(string_width) {
  ...
  char *format = "%15s";
  char *val = "666 IS MY FAVORITE NUMBER";
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(string_long) {
  ...
  char *format = "%s";
  char *val =
      "666 IS MY FAVORITE NUMBER THIS IS SUPPOSED TO BE A VERY LONG STRING";
  ck_assert_int_eq(s21_sprintf(str1, format, val), sprintf(str2, format, val));
